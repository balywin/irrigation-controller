...
void init_oled();
void oled_show(uint8_t line, const String& text, uint8_t size = 1, bool clear = true);
void oled_show_at(uint8_t pos, uint8_t line, const String& text, uint8_t size = 1, bool clear = true);
